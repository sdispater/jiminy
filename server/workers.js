...
var updateShowWorker = Job.processJobs('queue', 'updateShow',
    function (job, cb) {
        var data = job.data;
        ...
        try {
            ...
            if (show.last_info_sync / 1000 >= showData.last_updated) {
                Meteor.call('notify', '[Show Update] Nothing new for show ' + show.name, 'success');
            ...
            job.done(function(err) {
                ...
                Meteor.call('notify', '[Show Update]Finished updating show ' + show.name, 'success');
